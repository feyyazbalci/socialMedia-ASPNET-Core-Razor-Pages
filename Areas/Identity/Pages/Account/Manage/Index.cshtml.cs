...
namespace termProject_201811010.Areas.Identity.Pages.Account.Manage
{
    ...
    public class IndexModel : PageModel
    {
        ...
        public IndexModel(
            ...
            SignInManager<IdentityUser> signInManager, Models.canbookramContext context)
        {
        ...
        public IActionResult OnPostHideProfile()
        {
            var UserId = User.FindFirstValue(ClaimTypes.NameIdentifier);
            var user = _context.UserProfiles.FirstOrDefault(p => p.UserId == UserId);

            user.HideProfile = user.HideProfile == true ? false : true;
